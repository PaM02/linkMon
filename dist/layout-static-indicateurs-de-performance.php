<?php 
    ...
    $CE_FREQUENCE;
    $CE_P;
    $reponse = $bdd->query("SELECT CE_P1,CE_P2,CE_P3,CE_I1,CE_I2,CE_I3,CE_U1,CE_U2,CE_U3,CE_E,CE_FP,CE_FREQUENCE,CE_P FROM temps_reel");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Indicateurs de Performance</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Tableau de bord</a></li>
                            <li class="breadcrumb-item active">Indicateurs de Performance</li>
                        </ol>    
                        <div class="card mb-4" style="height:570px">
                            <div class="card-body bg-background-image " style="margin: auto;width:80%;">
