...
<html lang="en">
    ...
    <body>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        <div class="input-group mb-3 justify-content-center">
                                            <select name="toggle_column"  id="toggle_column" class="form-control" data-animate ="slide" data-filter ="true" data-filter-placeholder="Rechercher" multiple >
                                                ...
                                                <option  selected="selected" value="3">GETension_Batt</option>
                                                <option  selected="selected" value="4">GETemp_Moteur</option>
                                                <option  selected="selected" value="5">GEVitesse_Moteur</option>
                                                <option   value="6">GEPression_Huile</option>
                                                <option   value="7">GEEtat_du_Moteur</option>
                                                <option   value="8">GETension_L1_N</option>
                                                <option   value="9">GEFrequence</option>
                                                <option   value="10">GECourant_Phase1</option>
                                                <option   value="11">GE_Heures</option>
                                                <option   value="12">GE_Energie</option>
                                            </select>
                                        </div>
                                    </div>
                                </div> 
                                    ...
                                    <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                                        <thead class="text-center">
                                            <tr>
                                                ...
                                                <th>TRHeure</th>
                                                <th>GETension_Batt</th>
                                                <th>GETemp_Moteur</th>
                                                <th>GEVitesse_Moteur</th>                                 
                                                <th>GEPression_Huile</th>
                                                <th>GEEtat_du_Moteur</th>
                                                <th>GETension_L1_N</th>
                                                <th>GEFrequence</th>
                                                <th>GECourant_Phase1</th>
                                                <th>GE_Heures</th>
                                                <th>GE_Energie</th>
                                            </tr>
                                        </thead>
                                    ...
                                    <div class=" col-xl-2 col-md-6">
                                        <div class="input-group mb-3 justify-content-center">
                                            <select name="params" data-position='top' id="params" placeholder="paramètres" class="form-control" data-animate ="slide" data-filter ="false" data-filter-placeholder="Rechercher" multiple >
                                                <option   value="0">GETension_Batt</option>
                                                <option   value="1">GETemp_Moteur</option>
                                                <option   value="2">GEVitesse_Moteur</option>
                                                <option   value="3">GEPression_Huile</option>
                                                <option   value="4">GEEtat_du_Moteur</option>
                                                <option   value="5">GETension_L1_N</option>
                                                <option   value="6">GEFrequence</option>
                                                <option   value="7">GECourant_Phase1</option>
                                                <option   value="8">GE_Heures</option>
                                                <option   value="9">GE_Energie</option>    
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-2 col-md-6">
                    ...
                    success: function(data) {
                        ...
                        my_table =  $('#example').DataTable({
                            ...
                            "columns": [
                                ...
                                {"data": "GETension_Batt"},
                                {"data": "GETemp_Moteur"},
                                {"data": "GEVitesse_Moteur"},
                                {"data": "GEPression_Huile"},
                                {"data": "GEEtat_du_Moteur"},
                                {"data": "GETension_L1_N"},
                                {"data": "GEFrequence"},
                                {"data": "GECourant_Phase1"},
                                {"data": "GE_Heures"},
                                {"data": "GE_Energie"}
        ...
        <script type="text/javascript">
            ...
            function GETension_Batt(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GETension_Batt');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GETension_Batt = jsonData.GETension_Batt;
                    data.addRows([[jours,GETension_Batt]]);
            ...
            function GETemp_Moteur(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GETemp_Moteur');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GETemp_Moteur = parseInt($.trim(jsonData.GETemp_Moteur)) ;
                    data.addRows([[jours,GETemp_Moteur]]);
            ...
            function GEVitesse_Moteur(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GEVitesse_Moteur');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GEVitesse_Moteur = parseInt($.trim(jsonData.GEVitesse_Moteur)) ;
                    data.addRows([[jours,GEVitesse_Moteur]]);
            ...
            function GEPression_Huile(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GEPression_Huile');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GEPression_Huile = parseInt($.trim(jsonData.GEPression_Huile)) ;
                    data.addRows([[jours,GEPression_Huile]]);
            ...
            function GEEtat_du_Moteur(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GEEtat_du_Moteur');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GEEtat_du_Moteur = parseInt($.trim(jsonData.GEEtat_du_Moteur)) ;
                    data.addRows([[jours,GEEtat_du_Moteur]]);
            ...
            function GETension_L1_N(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GETension_L1_N');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GETension_L1_N = parseInt($.trim(jsonData.GETension_L1_N)) ;
                    data.addRows([[jours,GETension_L1_N]]);
            ...
            function GEFrequence(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GEFrequence');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GEFrequence = parseInt($.trim(jsonData.GEFrequence)) ;
                    data.addRows([[jours,GEFrequence]]);
            ...
            function GECourant_Phase1(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GECourant_Phase1');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GECourant_Phase1 = parseInt($.trim(jsonData.GECourant_Phase1)) ;
                    data.addRows([[jours,GECourant_Phase1]]);
            ...
            function GE_Heures(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GE_Heures');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GE_Heures = jsonData.GE_Heures;
                    data.addRows([[jours,GE_Heures]]);
            ...
            function GE_Energie(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();

                data.addColumn('string', 'jours');
                data.addColumn('number', 'GE_Energie');

                $.each(jsonData, function(i, jsonData){
                    var jours = jsonData.jours;
                    var GE_Energie = jsonData.GE_Energie;
                    data.addRows([[jours,GE_Energie]]);
        ...
        <script type="text/javascript">
            ...
            function GETension_BattGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var GETension_Batt = jsonData.GETension_Batt;
                    data.addRows([[datHeure,GETension_Batt]]);
            ...
            function GETemp_MoteurGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var datHeure = jours+","+heure;
                    var GETemp_Moteur = parseInt($.trim(jsonData.GETemp_Moteur));
                    data.addRows([[datHeure,GETemp_Moteur]]);
            ...
            function GEVitesse_MoteurGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var datHeure = jours+","+heure;
                    var GEVitesse_Moteur = parseInt($.trim(jsonData.GEVitesse_Moteur));
                    data.addRows([[datHeure,GEVitesse_Moteur]]);
            ...
            function GEPression_HuileGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var datHeure = jours+","+heure;
                    var GEPression_Huile = parseInt($.trim(jsonData.GEPression_Huile));
                    data.addRows([[datHeure,GEPression_Huile]]);
            ...
            function GEEtat_du_MoteurGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var heure = jsonData.heure;
                    var datHeure = jours+","+heure;
                    var GEEtat_du_Moteur = parseFloat($.trim(jsonData.GEEtat_du_Moteur));
                    data.addRows([[datHeure,GEEtat_du_Moteur]]);
            ...
            function GETension_L1_NGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var datHeure = jours+","+heure;
                    var GETension_L1_N = parseInt($.trim(jsonData.GETension_L1_N));
                    data.addRows([[datHeure,GETension_L1_N]]);
            ...
            function GEFrequenceGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var datHeure = jours+","+heure;
                    var GEFrequence = parseInt($.trim(jsonData.GEFrequence));
                    data.addRows([[datHeure,GEFrequence]]);
            ...
            function GECourant_Phase1Graph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var heure = jsonData.heure;
                    var datHeure = jours+","+heure;
                    var GECourant_Phase1 = parseFloat($.trim(jsonData.GECourant_Phase1));
                    data.addRows([[datHeure,GECourant_Phase1]]);
            ...
            function GE_HeuresGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var datHeure = jours+","+heure;
                    var GE_Heures = jsonData.GE_Heures;
                    data.addRows([[datHeure,GE_Heures]]);
            ...
            function GE_EnergieGraph(chart_data, chart_main_title){
                var jsonData = chart_data;
                var data = new google.visualization.DataTable();
                ...
                $.each(jsonData, function(i, jsonData){
                    ...
                    var heure = jsonData.heure;
                    var datHeure = jours+","+heure;
                    var GE_Energie = jsonData.GE_Heures;
                    data.addRows([[datHeure,GE_Energie]]);
